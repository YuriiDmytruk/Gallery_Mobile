...
const MyFriendLine = ({ user, loggedInUser }) => {
  ...
  const onDeleteClick = async () => {
    setIsDisabled(true);
    await patchFriend(loggedInUser._id, user._id, 'delete');
    const userData = (
      await putUser({
  ...
  return (
    <View style={styles.userContainer}>
      ...
      <View style={styles.buttonContainer}>
        <Button mode="elevated" onPress={onDeleteClick} disabled={isDisabled}>
          <Text variant="titleMedium">Delete Friend</Text>
        </Button>
